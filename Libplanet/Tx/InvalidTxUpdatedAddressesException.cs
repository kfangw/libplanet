...
namespace Libplanet.Tx
{
    ...
    /// <see cref="Transaction.Actions"/> try to update any
    /// <see cref="Address"/>es that are not included in
    /// <see cref="Transaction.UpdatedAddresses"/> (i.e., <see
    /// cref="Address"/>es that <see cref="Transaction"/>'s
    /// <see cref="Transaction.Signer"/> granted to update.)
    /// </summary>
    public class InvalidTxUpdatedAddressesException : InvalidTxException
    {
        ...
        /// <see cref="Address"/>es that <see cref="Transaction"/>'s
        /// <see cref="Transaction.Signer"/> granted to update.
        /// </summary>
        public IImmutableSet<Address> UpdatableAddresses { get; }

        /// <summary>
        /// <see cref="Address"/>es that <see cref="Transaction.Actions"/>
