...
{
    /// <summary>
    /// An interface to determine if consecutive <see cref="Block"/>s are
    /// valid, and to suggest how difficult a <see cref="Block.Nonce"/>
    /// for a <see cref="Block"/> to be mined.
    /// </summary>
    public interface IBlockPolicy
    {
        ...
        /// <summary>
        /// The maximum number of <see cref="Block.Transactions"/> that a <see cref="Block"/>
        ...
        /// </summary>
        /// <param name="transaction">A <see cref="Transaction"/> to determine.</param>
        /// <param name="blockChain">A <see cref="BlockChain" /> for given
        ...
        /// </summary>
        /// <param name="blocks">Consecutive <see cref="Block"/>s to
        ...
        /// <em>valid</em>.</returns>
        InvalidBlockException? ValidateNextBlock(BlockChain blocks, Block nextBlock);

        /// <summary>
        /// Determines a right <see cref="Block.Difficulty"/>
        /// for a new <see cref="Block"/> to be mined
        /// right after the given <paramref name="blocks"/>.
        /// </summary>
        /// <param name="blocks">Consecutive <see cref="Block"/>s to be
        /// followed by a new <see cref="Block"/> to be mined.</param>
        /// <returns>A right <see cref="Block.Difficulty"/>
        /// for a new <see cref="Block"/> to be mined.</returns>
        long GetNextBlockDifficulty(BlockChain blocks);

        /// <summary>
        /// Gets the maximum length of a <see cref="Block"/> in bytes.  It can vary depending on
        /// a given <paramref name="index"/>, but should be deterministic; for the same
        /// <paramref name="index"/>, the same value must be returned.
        /// </summary>
        /// <param name="index">An <see cref="Block.Index"/> of a block to mine or receive.
        /// </param>
        /// <returns>The maximum length of a <see cref="Block"/> in bytes to accept.</returns>
