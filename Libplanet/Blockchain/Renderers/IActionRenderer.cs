...
namespace Libplanet.Blockchain.Renderers
{
    ...
    /// <list type="number">
    /// <item><description><see cref="IRenderer.RenderReorg(Block, Block, Block)"/>
    ...
    /// </item>
    /// <item><description><see cref="IRenderer.RenderReorgEnd(Block, Block, Block)"/>
    /// (one time)</description></item>
    /// </list>
    /// </summary>
    ...
    /// cref="IActionRenderer"/>s, it is not guaranteed that actions in a transaction are atomic.
